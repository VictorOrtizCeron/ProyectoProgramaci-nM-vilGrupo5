...
import 'perfil_repartidor_model.dart';
export 'perfil_repartidor_model.dart';

class PerfilRepartidorWidget extends StatefulWidget {
  const PerfilRepartidorWidget({super.key});

  static String routeName = 'PerfilRepartidor';
  static String routePath = '/perfilRepartidor';

  @override
  State<PerfilRepartidorWidget> createState() => _PerfilRepartidorWidgetState();
}

class _PerfilRepartidorWidgetState extends State<PerfilRepartidorWidget> {
  late PerfilRepartidorModel _model;
                                        ...
                                        onTap: () async {
                                          ...
                                          if (selectedMedia != null &&
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadDataU72 =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_uploadDataU72 =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_uploadDataU72 =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                                          ...
                                          decoration: InputDecoration(
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'za9c2dyz' /* Ingresa tu nombre completo */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodyMedium
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                                  .textFieldCorreoTextController ??=
                                              TextEditingController(
                                            text: columnUsuariosRecord.email,
                                          ),
                                          focusNode:
                                              _model.textFieldCorreoFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                                  .textFieldNumTelTextController ??=
                                              TextEditingController(
                                            text: columnUsuariosRecord
                                                .phoneNumber,
                                          ),
                                          focusNode:
                                              _model.textFieldNumTelFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              ...
                                              TextEditingController(
                                            text:
                                                columnUsuariosRecord.direccion,
                                          ),
                                          focusNode: _model
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await currentUserReference!
                            ...
                            email: _model.textFieldCorreoTextController.text,
                            photoUrl: _model.uploadedFileUrl_uploadDataU72 !=
                                        null &&
                                    _model.uploadedFileUrl_uploadDataU72 != ''
                                ? _model.uploadedFileUrl_uploadDataU72
                                : currentUserPhoto,
                            phoneNumber:
                                _model.textFieldNumTelTextController.text,
                            direccion:
