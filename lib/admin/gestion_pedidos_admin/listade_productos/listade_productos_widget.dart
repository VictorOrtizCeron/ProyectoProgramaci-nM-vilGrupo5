...
import 'listade_productos_model.dart';
export 'listade_productos_model.dart';
                  ...
                  children: [
                    ...
                    StreamBuilder<List<CarritoRecord>>(
                      stream: queryCarritoRecord(
                        queryBuilder: (carritoRecord) => carritoRecord
                            ...
                            .where(
                              'Cliente_Ref',
                              isEqualTo: containerPedidoRecord?.clienteRef,
                            ),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        ...
                        return SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: List.generate(
                                columnCarritoRecordList.length, (columnIndex) {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          valueOrDefault<String>(
                            containerPedidoRecord?.pedTotal?.toString(),
                            'Error al cargar',
                          ),
                          style:
