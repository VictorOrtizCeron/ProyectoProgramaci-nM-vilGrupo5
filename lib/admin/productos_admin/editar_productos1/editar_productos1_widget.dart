...
import 'editar_productos1_model.dart';
export 'editar_productos1_model.dart';

class EditarProductos1Widget extends StatefulWidget {
  const EditarProductos1Widget({super.key});

  static String routeName = 'EditarProductos1';
  static String routePath = '/editarProductos1';

  @override
  State<EditarProductos1Widget> createState() => _EditarProductos1WidgetState();
}

class _EditarProductos1WidgetState extends State<EditarProductos1Widget> {
  late EditarProductos1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarProductos1Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProductoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductoRecord> editarProductos1ProductoRecordList =
            snapshot.data!;
                                                      ...
                                                      () async {
                                                        safeSetState(() {
                                                          _model.simpleSearchResults =
                                                              TextSearch(
                                                            editarProductos1ProductoRecordList
                                                                .map(
