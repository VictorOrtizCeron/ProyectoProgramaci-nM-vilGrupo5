...
import 'agregar_productos1_model.dart';
export 'agregar_productos1_model.dart';

class AgregarProductos1Widget extends StatefulWidget {
  const AgregarProductos1Widget({super.key});

  static String routeName = 'AgregarProductos1';
  static String routePath = '/agregarProductos1';

  @override
  State<AgregarProductos1Widget> createState() =>
      _AgregarProductos1WidgetState();
}

class _AgregarProductos1WidgetState extends State<AgregarProductos1Widget> {
  late AgregarProductos1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregarProductos1Model());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ProductoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductoRecord> agregarProductos1ProductoRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final agregarProductos1ProductoRecord =
            agregarProductos1ProductoRecordList.isNotEmpty
                ? agregarProductos1ProductoRecordList.first
                : null;
                                ...
                                onTap: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadDataTps =
                                          false;
                                    }
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primary,
                                validator: _model
                                    .txtStockMinTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [
                                  if (!isAndroid && !isiOS)
                                    TextInputFormatter.withFunction(
                            ...
                            _model.productocreado =
                                ProductoRecord.getDocumentFromData(
                                    createProductoRecordData(
                                      ...
                                      proStockMinimo: valueOrDefault<int>(
                                        int.tryParse(_model
                                            .txtStockMinTextController.text),
                                        0,
                                      ),
                                      proFotoUrl: valueOrDefault<String>(
                                        _model.uploadedFileUrl_uploadDataTps,
