...
class PerfilAdminModel extends FlutterFlowModel<PerfilAdminWidget> {
  ...
  String? direccionActualizar;

  ///  State fields for stateful widgets in this page.

  final formKey = GlobalKey<FormState>();
  // Stores action output result for [Action Block - ObtenerNombreUbicacion] action in PerfilAdmin widget.
  String? ubicacionReal;
  // State field(s) for Column widget.
  ScrollController? columnController;
  bool isDataUploading_uploadDataU80 = false;
  FFUploadedFile uploadedLocalFile_uploadDataU80 =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadDataU80 = '';
