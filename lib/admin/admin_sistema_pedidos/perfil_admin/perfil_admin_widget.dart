                                        ...
                                        onTap: () async {
                                          ...
                                          if (selectedMedia != null &&
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadDataU80 =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_uploadDataU80 =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_uploadDataU80 =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                                            ...
                                            decoration: InputDecoration(
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'g9v0rhfm' /* Ingresa tu nombre completo */,
                                              ),
                                              hintStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await currentUserReference!
                          ...
                          photoUrl:
                              _model.uploadedFileUrl_uploadDataU80 != null &&
                                      _model.uploadedFileUrl_uploadDataU80 != ''
                                  ? _model.uploadedFileUrl_uploadDataU80
                                  : currentUserPhoto,
                          phoneNumber:
