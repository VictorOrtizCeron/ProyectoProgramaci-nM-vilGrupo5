...
import 'admin_cart_model.dart';
export 'admin_cart_model.dart';

class AdminCartWidget extends StatefulWidget {
  const AdminCartWidget({
    super.key,
  ...
  static String routeName = 'AdminCart';
  static String routePath = '/adminCart';

  @override
  State<AdminCartWidget> createState() => _AdminCartWidgetState();
}

class _AdminCartWidgetState extends State<AdminCartWidget> {
  late AdminCartModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminCartModel());
              ...
              child: Row(
                ...
                children: [
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      context.pushNamed(VerFacturasWidget.routeName);
                    },
                  ),
                  FlutterFlowIconButton(
                    borderRadius: 20.0,
                            ...
                            children: [
                              Expanded(
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                        HomeScreenAdminWidget.routeName);
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    'uah8j3au' /* Agregar plato */,
                                  ),
                                  icon: Icon(
                              ...
                              Expanded(
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed(
                                        ConfirmaPagoAdminWidget.routeName);
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    'iirakjrx' /* Pagar */,
                                  ),
