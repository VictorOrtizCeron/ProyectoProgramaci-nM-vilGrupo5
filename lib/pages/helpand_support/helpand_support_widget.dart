...
class HelpandSupportWidget extends StatefulWidget {
  ...
  static String routeName = 'HelpandSupport';
  static String routePath = '/helpandSupport';
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'f4y39b4e' /* Need help? Our support team is... */,
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'l23mhqgh' /* Lunes a Viernes: 9:00 AM - 8:0... */,
                                                    ),
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'jyz93dqk' /* • Problemas de acceso a la cue... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        FFButtonWidget(
                                          onPressed: () async {
                                            await launchURL(
                                                'https://wa.me/qr/TO34ERHUVGHYI1');
                                          },
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            'vxzqhxxf' /* Abrir WhatsApp */,
                                          ),
                                          icon: Icon(
