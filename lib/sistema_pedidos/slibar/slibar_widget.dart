...
import 'slibar_model.dart';
export 'slibar_model.dart';

class SlibarWidget extends StatefulWidget {
  const SlibarWidget({super.key});

  @override
  State<SlibarWidget> createState() => _SlibarWidgetState();
}

class _SlibarWidgetState extends State<SlibarWidget> {
  late SlibarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SlibarModel());
            ...
            children: [
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    context.pushNamed(UserCartOficialWidget.routeName);
                  },
                  child: Container(
                    width: double.infinity,
                    decoration: BoxDecoration(
