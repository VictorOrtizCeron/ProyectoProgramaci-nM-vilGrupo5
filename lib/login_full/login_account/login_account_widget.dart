                                    ...
                                    Expanded(
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if (_model.authError != null &&
                                              _model.authError != '') {
                                            await actions.warningNotification(
                                              context,
                                              'Error de Acceso!',
                                              'Error al escribir tus credenciales',
                                              2,
                                              () async {},
                                              () async {},
                                            );
                                            ...
                                            if (currentUserDocument?.estado ==
                                                UserEstadoDatos.Activo) {
                                              if (valueOrDefault(
                                                          currentUserDocument
                                                              ?.roles,
                                                          '') ==
